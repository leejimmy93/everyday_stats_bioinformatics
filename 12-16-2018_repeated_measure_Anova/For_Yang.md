...
data[1:3,] %>% 
  ggplot() + 
  geom_point(mapping=aes(x=condition,y=mean),stat="identity", size = 1, color = "darkorange") + 
...
data[4:6,] %>% 
  ggplot() + 
  geom_point(mapping=aes(x=condition,y=mean),stat="identity", size = 1, color = "blue") + 
